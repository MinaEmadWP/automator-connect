...
/**
 * Class WP_Ulike_User_Likes_Post_Type
 *
 * Fires when a user likes a post type through WP ULike.
 * 
 * @package Automator_Connect\Integrations\WP_Ulike
 */
class WP_Ulike_User_Likes_Post_Type extends Trigger {
	 ...
	 * @var string
	 */
	const TRIGGER_CODE = 'USER_LIKES_POST_TYPE';
	...
	/**
	 * WP ULike vote status for a like.
	 *
	 * @var string
	 */
	 ...
	 * as nine arguments.
	 *
	 * For a post like, the relevant arguments are:
	 *
	 * 0 - Post ID.
	 * 2 - User ID.
	...
	public function validate( $trigger, $hook_args ) {
		...
		// Only process actual likes, not unlikes.
		if ( self::LIKE_STATUS !== $hook_args[ self::ARG_STATUS ] ) {
			return false;
		}
		...
		// Make sure the liked post exists and has a valid post type.
