...
/**
 * Class WP_Ulike_User_Likes_Comment
 *
 * Fires when a user likes a comment through WP ULike.
 * 
 * @package Automator_Connect\Integrations\WP_Ulike
 */
class WP_Ulike_User_Likes_Comment extends Trigger {
	 ...
	 * @var string
	 */
	const TRIGGER_CODE = 'USER_LIKES_COMMENT';
	 ...
	 * as nine arguments.
	 *
	 * For a comment like, the relevant arguments are:
	 *
	 * 0 - Comment ID.
	 * 2 - User ID.
